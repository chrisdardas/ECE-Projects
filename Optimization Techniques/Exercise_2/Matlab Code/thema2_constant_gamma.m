...
[p,min_x_1,min_y_1,~,a,b] = Steepest_Descent(f,gamma,x1);
...
[p,min_x_2,min_y_2,~,a,b] = Steepest_Descent(f,gamma,x2);
...
[p,min_x_3,min_y_3,~,a,b] = Steepest_Descent(f,gamma,x3);
...
%g_1 = zeros(1,100);
%i = 0;
%for gamma = linspace(0.2,1.2,100)
   % i = i + 1;
    %[p(i),min_x(i),min_y(i),g_1(i)] = Steepest_Descent(f,gamma,x1);
