...
[p,min_x_1,min_y_1,a,b] = Steepest_Descent_Armijo(f,x1);
...
xlabel('X')
ylabel('Y')
title('γk with Armijo')
figure

[p,min_x_2,min_y_2,a,b] = Steepest_Descent_Armijo(f,x2);
...
[p,min_x_3,min_y_3,a,b] = Steepest_Descent_Armijo(f,x3);
